...
export default {
  ...
  data() {
    return {
      ...
      address: "",
      connecting: false,
      provider: new JsonRpcProvider("https://alloys-rpc.maxonrow.com", {
        chainId: "alloys",
        name: "alloys",
      }),
    };
          ...
          msg: [
            {
              type: "mxw/msgSend",
              value: {
                amount: [{ amount: "10000000000000", denom: "cin" }],
                from_address: "mxw1edl2ef5c45acvn7062lgz53szyspqx7psxrm4w",
                to_address: "mxw1hl456zwwc2vl3rq6p4y2amhvpn8znhzt9axn35",
              },
            },
          ],
          memo: "this is a memo test",
        },
        fee: { amount: [{ amount: "0", denom: "cin" }], gas: "0" },
        chainId: "alloys",
        nonce: 75,
        accountNumber: 778,
      };
